...
- **Cost ceiling over convenience.** Where a cost constraint (single EIP, `t3`/`t4g` medium-only whitelist, 4h idle stop) trades off against operational convenience, the cost constraint wins.
