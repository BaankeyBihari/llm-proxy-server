...
- [x] **LOCAL-004**: For each owned key, in file order, the script shall display the current value and prompt for a replacement, unconditionally regardless of `[config].secrets_mode`.
